...
CS_ShapedMembershipFunction func1(50,100);
...
//--- create curve
   graphic.CurveAdd(S_ShapedMembershipFunction1,-100,100,0.1,CURVE_LINES,"[90, 2]");
...
//--- sets the X-axis properties
   graphic.XAxis().AutoScale(true);
  // graphic.XAxis().Min(-100.0);
  // graphic.XAxis().Max(100.0);
